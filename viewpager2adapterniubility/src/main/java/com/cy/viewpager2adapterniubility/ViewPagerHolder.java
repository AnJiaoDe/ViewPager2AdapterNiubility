...
public class ViewPagerHolder implements IViewHolder {
    ...
    public ViewPagerHolder putView(int viewId, View view) {
        array_view.put(viewId, view);
        return this;
    }
    ...
    //设置View显示
    public ViewPagerHolder setVisible(int res_id) {
        getView(res_id).setVisibility(View.VISIBLE);
        return this;
    }
    //设置View隐藏

    public ViewPagerHolder setInVisible(int res_id) {
    ...
    public ViewPagerHolder setText(int tv_id, Object text) {
    ...
    //设置TextView 前面+¥
    public ViewPagerHolder setPriceText(int tv_id, Object text) {
        TextView tv = getView(tv_id);
    ...
    public ViewPagerHolder setTextColor(int tv_id, int color) {
        TextView tv = getView(tv_id);
    ...
    public ViewPagerHolder setBackgroundResource(int v_id, int resid) {
    ...
    public ViewPagerHolder setImageBitmap(int iv_id, Bitmap bitmap) {
    ...
    public ViewPagerHolder setImageResource(int iv_id, int resID) {
        ImageView view = getView(iv_id);
