...
public class ViewPager2Holder extends RecyclerView.ViewHolder implements IViewHolder {
    ...
    public ViewPager2Holder putView(int viewId, View view) {
        array_view.put(viewId, view);
        return this;
    }
    ...
    //设置View显示
    public ViewPager2Holder setVisible(int res_id) {
        getView(res_id).setVisibility(View.VISIBLE);
        return this;
    }
    //设置View隐藏

    public ViewPager2Holder setInVisible(int res_id) {
    ...
    public ViewPager2Holder setText(int tv_id, Object text) {
    ...
    //设置TextView 前面+¥
    public ViewPager2Holder setPriceText(int tv_id, Object text) {
        TextView tv = getView(tv_id);
    ...
    public ViewPager2Holder setTextColor(int tv_id, int color) {
        TextView tv = getView(tv_id);
    ...
    public ViewPager2Holder setBackgroundResource(int v_id, int resid) {
    ...
    public ViewPager2Holder setImageBitmap(int iv_id, Bitmap bitmap) {
    ...
    public ViewPager2Holder setImageResource(int iv_id, int resID) {
        ImageView view = getView(iv_id);
